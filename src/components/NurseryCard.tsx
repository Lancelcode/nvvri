...
type BadgeType = "outstanding" | "good" | "requires-improvement" | "available" | "waitlist" | "default";

function Badge({ children, type = "default" }: { children: React.ReactNode; type?: BadgeType }) {
  const styles: Record<BadgeType, React.CSSProperties> = {
    ...
    "requires-improvement":{ background: "#fff7ed", color: "#9a3412", border: "1px solid #fed7aa" },
  ...
  return (
    <span style={{ fontSize: 11, fontWeight: 500, padding: "2px 8px", borderRadius: 20, ...styles[type] }}>
      {children}
    </span>
  );
}
